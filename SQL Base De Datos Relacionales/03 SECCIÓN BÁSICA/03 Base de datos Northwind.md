...
- *La base de datos **Northwind** es una base de datos de ejemplo ampliamente utilizada para el aprendizaje de conceptos y operaciones en bases de datos relacionales. Fue desarrollada por Microsoft para ilustrar la funcionalidad de su sistema de gestión de bases de datos, y ha sido adaptada a diferentes entornos como **SQLite**.*

- *La base de datos **Northwind** simula un entorno comercial con información de clientes, pedidos, productos, proveedores y más, proporcionando un entorno práctico para realizar consultas SQL y comprender la estructura de una base de datos real.*

### ***Estructura de la Base de Datos:***

- **Tablas principales:**
  - **Customers (Clientes):** *Información sobre los clientes de la empresa.*
  - **Orders (Pedidos):** *Detalles de las órdenes o pedidos de los clientes.*
  - **Employees (Empleados):** *Datos sobre los empleados de la empresa.*
  - **Products (Productos):** *Información sobre los productos que vende la empresa.*
  - **Suppliers (Proveedores):** *Datos sobre los proveedores que suministran productos.*
  - **Categories (Categorías):** *Clasificación de los productos en diferentes grupos.*
...
- **Aprende más sobre Northwind en el siguiente enlace:**
  - *[Northwind en Wikiversity (SQLite)](https://en.wikiversity.org/wiki/Database_Examples/Northwind/SQLite "https://en.wikiversity.org/wiki/Database_Examples/Northwind/SQLite")*
  - *[Northwind en Wikiversity (General)](https://en.wikiversity.org/wiki/Database_Examples/Northwind "https://en.wikiversity.org/wiki/Database_Examples/Northwind")*
...
```sql
sqlite> .tables
Categories    Employees     Orders        Shippers
Customers     OrderDetails  Products      Suppliers
```
