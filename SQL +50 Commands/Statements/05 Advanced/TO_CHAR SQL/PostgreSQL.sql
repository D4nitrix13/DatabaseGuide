...
SELECT c.codigo_cliente, c.nombre_cliente, p.fecha_pedido, p.fecha_esperada, COALESCE(
...
-- Aquí tienes ejemplos de cómo usar las funciones `CAST` y `CONVERT` en SQL Server, MySQL, PostgreSQL y SQLite3, tomando como referencia tu consulta original.
